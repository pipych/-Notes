        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-m3-outline-variant/15 flex-shrink-0">
          {isSidebarExpanded ? (
            <>
              ...
              >
                <MaterialIcon name="menu_open" size={22} />
              </button>
            </>
          ) : (
            <button
              onClick={() => setIsSidebarExpanded(true)}
              className="w-10 h-10 rounded-full flex items-center justify-center mx-auto hover:bg-m3-surface-container active:scale-95 transition-all focus:outline-none"
